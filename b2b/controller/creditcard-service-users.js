...
function get_data(page, filter) {
  ...
  param.append("_action", "get_creditcard_users");
  param.append("payload", "creditcard-service-users");
  ...
  result.forEach((element) => {
    ...
    bodyHTML += `<tr><td>
    <button type="button" class="btn btn-primary bg-primary btn-sm" data-bs-toggle="modal" data-status="${element.requeststatus}" data-id="${element.service_id}" data-remarks="${element.remarks}" data-service="CREDIT_CARD"
